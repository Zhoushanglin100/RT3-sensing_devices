...
import torch
from generate_rl_input import random_generate_rl_input, extract_generate_rl_input
...
controller_params = {
    "model": model,
    "sw_space":(para_set),
    "level_space":([[[0, 1, 2], [0, 1, 3], [0, 1, 4], [0, 1, 5], [0, 1, 6], [0, 1, 7], [0, 1, 8], [0, 1, 9], 
                     [0, 2, 3], [0, 2, 4], [0, 2, 5], [0, 2, 6], [0, 2, 7], [0, 2, 8], [0, 2, 9], 
                     [0, 3, 4], [0, 3, 5], [0, 3, 6], [0, 3, 7], [0, 3, 8], [0, 3, 9], 
