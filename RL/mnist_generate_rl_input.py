...
from Generate_patterns.mnist_extract_info_from_precompression import compute_importance_weight, generate_layer_pattern
...
def extract_generate_rl_input(model,block_size,prune_ratios,pruning_number_list):
    importance_weight_dict = compute_importance_weight(model, block_size, 5, 8, 5, prune_ratios)
