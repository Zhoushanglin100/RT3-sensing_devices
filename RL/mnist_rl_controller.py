...
from Pruning.mnist_pattern_pruning_CPU import build_whole_pattern
from Pruning.mnist_precompression_extract_joint_training import train_prune
from mnist_rl_input import controller_params, pruning_number_list, block_size
import termplotlib as tpl
import copy
import random
import torch

from utils.mnist_runs_number_reward import times_reward
from utils.mnist_sparsity_ratio import whole_sparsity_ratio, sparsity_ratio

from mnist_rl_input import prune_ratios
...
class Controller(object):
    ...
    def para2interface_NN(self, Para_NN1, Para_level,model,epochs,timing_constraint):# Train the pruning network through the selected sub-network parameters
        ...
        accuracy_reward = (weighted_accuracy - 0.9) / (0.99 - 0.9)
